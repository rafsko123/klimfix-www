    ...
    content: [
      {
        ...
        list: [
          ...
          },
          {
            ...
            description: <>Mycie detailingowe, dekontaminacja lakieru, <b>jednoetapowa</b> korekta lakieru, aplikacja wosku 3-miesięcznego +&nbsp;niewidzialna wycieraczka GRATIS! Usuwa ok. 50% zarysowań</>,
            bolded: false,
            price: "od 800 zł",
          },
          {
            title: "Wieloetapowa korekta lakieru",
            description: <>Mycie detailingowe, dekontaminacja lakieru, <b>wieloetapowa</b> korekta lakieru, aplikacja wosku 3-miesięcznego. Usuwa ok. 50% zarysowań</>,
            bolded: false,
          ...
          {
            title: "Roczne zabezpieczenie powłoką ceramiczną",
            description: "*Do ceny należy doliczyć korektę lakieru w zależności od stanu powłoki lakiernicze",
            bolded: false,
            price: "od 500 zł",
          },
          {
            title: "3-letnie zabezpieczenie powłoką ceramiczną",
            description: "*Do ceny należy doliczyć korektę lakieru w zależności od stanu powłoki lakierniczej",
            bolded: false,
            price: "od 1500 zł",
          },
          {
